...
<label>False</label>
         ...
         <div class="questionResult-header">
            ...
            </div> <h4 class="ml-3">'.$ques['qi_question'].' (T/F)</h4>';
            echo'</div */
...
$q5 = "insert into qi_quizes (qi_subject_id , qi_grade , qi_teacher_id  , name , level ,qi_q_num) values ('$topicID' ,'5' ,'$teacher_id' ,'$qName' ,' $qLevel', '$counter')";    //??????
